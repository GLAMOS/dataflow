    ...
    if os.path.exists(dataDirectoryPath):
        ...
        for inputFileName in os.listdir(dataDirectoryPath):
            ...
            try:
                ...
                massBalanceIndexDailyReader = MassBalanceIndexTimeDailyReader(config, inputFilePath, allGlaciers)
                ...
                massBalanceIndexDailyReader.glacier.massBalanceIndexTimeDailys.clear()
                ...
                if massBalanceIndexDailyReader != None:
                    ...
                    massBalanceIndexDailyWriter = MassBalanceIndexTimeDailyWriter(privateDatabaseAccessConfiguration)
